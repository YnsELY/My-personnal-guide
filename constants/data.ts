...
export const SERVICES = [
    ...
    },
    {
        ...
        description: 'Confiez-nous votre Omra Badal : une adoration accomplie avec sérieux, transparence et sincérité. Votre guide vous enverra une courte vidéo à l\'entrée en état de sacralisation (Ihram) ainsi qu\'à la fin de la Omra, pour vous permettre de vivre chaque étape en toute confiance.',
