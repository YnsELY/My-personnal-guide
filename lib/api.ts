...
export const getGuides = async () => {
    ...
    const guides = data.map((g: any) => ({
        ...
        image: resolveProfileAvatarSource(g.profiles?.avatar_url, g.profiles?.gender, 'guide'),
        location: g.location,
        verified: g.verified,
        bio: g.bio,
...
export const getRecommendedGuides = async (limit = 5) => {
    ...
    const guides = (data || []).map((g: any) => {
        ...
        return {
            ...
            priceUnit: g.price_unit || '',
            languages: g.languages || [],
            image: resolveProfileAvatarSource(g.avatar_url, g.gender, 'guide'),
...
export const getGuideById = async (id: string) => {
    ...
    return {
        ...
        priceUnit: g?.price_unit || '',
        languages: g?.languages || [],
        image: resolveProfileAvatarSource(data.avatar_url, data.gender, 'guide'),
        location: g?.location || 'Lieu non renseignÃƒÂ©',
