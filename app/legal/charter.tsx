import { CHARTER_TEXTS } from '@/constants/charter';
        ...
        <View className="flex-1 bg-white dark:bg-zinc-900" style={directionStyle(isRTL)}>
            ...
            <SafeAreaView className="flex-1" edges={['top']}>
                <View className="flex-row items-center px-4 py-3 border-b border-gray-100 dark:border-white/5" style={rowStyle(isRTL)}>
                    ...
                    <Text className="text-gray-900 dark:text-white font-bold text-lg" style={textStart(isRTL)}>{t('charterTitle')}</Text>
                </View>

                <ScrollView className="flex-1 px-6 py-5" contentContainerStyle={{ paddingBottom: 40 }}>
                    <Text className="text-gray-700 dark:text-gray-300 leading-7" style={textStart(isRTL)}>{CHARTER_TEXTS[language]}</Text>
                </ScrollView>
            </SafeAreaView>
        </View>
    );
